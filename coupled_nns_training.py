...
def lenet_coupling(checkpoint1, checkpoint2, class1a, class1b, class2a, class2b, save_path = '/nfs/ghome/live/ajain/checkpoints/di_cifar100/coupled', epochs=50, batch_size = 128, lr=0.01, momentum=0.9, weight_decay=0.0001, coupling_weight = 1, seed=42):
...
if __name__ == '__main__':
    lenet_coupling(class1a=1, class2a=3, class1b=9, class2b=13, checkpoint1='/nfs/ghome/live/ajain/checkpoints/di_cifar100/baseline/lenet_individual_1vs3.pth', checkpoint2='/nfs/ghome/live/ajain/checkpoints/di_cifar100/baseline/lenet_individual_9vs13.pth', epochs=100, batch_size=128, coupling_weight=1)