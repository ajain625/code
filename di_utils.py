...
def disparate_impact(model, class1a, class1b, class2a, class2b, cross=False, seed=42, save_path = '/nfs/ghome/live/ajain/checkpoints/di_cifar100/baseline/coarse', epochs=500, batch_size = 128, lr=0.01, momentum=0.9, weight_decay=0.0001, fine=False, random_split=True):
    ...
    if cross:
        ...
        cross_accuracy_c = cifar100_individual_train(model, class1a, class1b, seed=seed, save_path=save_path, epochs=epochs, batch_size=batch_size, lr=lr, momentum=momentum, weight_decay=weight_decay, split_order=split_order, fine=fine, random_split=random_split)
        cross_accuracy_d = cifar100_individual_train(model, class2a, class2b, seed=seed, save_path=save_path, epochs=epochs, batch_size=batch_size, lr=lr, momentum=momentum, weight_decay=weight_decay, split_order=split_order, fine=fine, random_split=random_split)
        print('Disparate Impact: {}, Individual Accuracy A: {}, Individual Accuracy B: {}, Joint Accuracy A: {}, Joint Accuracy B: {}, Cross Accuracy A: {}, Cross Accuracy B: {}, Cross Accuracy C: {}, Cross Accuracy D: {}'.format(disparate_impact, individual_accuracy_a, individual_accuracy_b, joint_accuracy_a, joint_accuracy_b, cross_accuracy_a, cross_accuracy_b, cross_accuracy_c, cross_accuracy_d))
        return disparate_impact, individual_accuracy_a, individual_accuracy_b, joint_accuracy_a, joint_accuracy_b, cross_accuracy_a, cross_accuracy_b, cross_accuracy_c, cross_accuracy_d
    else:
